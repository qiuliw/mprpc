...
class LoginResponse PROTOBUF_FINAL :
 ...
 public:
  ...
  // .fixbug.GetFriendListsRequest data = 2;
  bool has_data() const;
  private:
  bool _internal_has_data() const;
  public:
  void clear_data();
  const ::fixbug::GetFriendListsRequest& data() const;
  ::fixbug::GetFriendListsRequest* release_data();
  ::fixbug::GetFriendListsRequest* mutable_data();
  void set_allocated_data(::fixbug::GetFriendListsRequest* data);
  private:
  const ::fixbug::GetFriendListsRequest& _internal_data() const;
  ::fixbug::GetFriendListsRequest* _internal_mutable_data();
  public:
  void unsafe_arena_set_allocated_data(
      ::fixbug::GetFriendListsRequest* data);
  ::fixbug::GetFriendListsRequest* unsafe_arena_release_data();
 ...
 private:
  ...
  ::fixbug::GetFriendListsRequest* data_;
  bool success_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_test_2eproto;
};
...
inline const ::fixbug::GetFriendListsRequest& LoginResponse::_internal_data() const {
  const ::fixbug::GetFriendListsRequest* p = data_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::GetFriendListsRequest*>(
      &::fixbug::_GetFriendListsRequest_default_instance_);
}
inline const ::fixbug::GetFriendListsRequest& LoginResponse::data() const {
...
inline void LoginResponse::unsafe_arena_set_allocated_data(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:fixbug.LoginResponse.data)
}
inline ::fixbug::GetFriendListsRequest* LoginResponse::release_data() {
...
inline ::fixbug::GetFriendListsRequest* LoginResponse::unsafe_arena_release_data() {
  // @@protoc_insertion_point(field_release:fixbug.LoginResponse.data)
  
  ::fixbug::GetFriendListsRequest* temp = data_;
  data_ = nullptr;
  return temp;
}
inline ::fixbug::GetFriendListsRequest* LoginResponse::_internal_mutable_data() {
  
  if (data_ == nullptr) {
    auto* p = CreateMaybeMessage<::fixbug::GetFriendListsRequest>(GetArena());
    data_ = p;
  }
  return data_;
}
inline ::fixbug::GetFriendListsRequest* LoginResponse::mutable_data() {
  // @@protoc_insertion_point(field_mutable:fixbug.LoginResponse.data)
  return _internal_mutable_data();
}
inline void LoginResponse::set_allocated_data(::fixbug::GetFriendListsRequest* data) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete data_;
  }
  ...
  data_ = data;
  // @@protoc_insertion_point(field_set_allocated:fixbug.LoginResponse.data)
}
